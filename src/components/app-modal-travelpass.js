	...
	connectedCallback() {
          ...
          <div class="modal-content">
            ...
            <div class="card-modal">
              <div class="modal-header">
                  <img src="../src/assets/img/global/gho-img/logos/logo-travel-pass.webp" alt="Logotipo TravelPass" title="Monedero Eléctronico Formulario" width="100" height="32" class="modal-logo">
      ...
      <div id="modalTravelPassLogueado" class="ModalTravelPs">
            <div class="modal-content">
                ...
                <div class="card-modal">
                    <div class="modal-header">
                        <img src="../src/assets/img/global/gho-img/logos/logo-travel-pass.webp" alt="Logotipo TravelPass" title="Logo Monedero Eléctronico" width="100" height="32" class="modal-logo">
                    </div>
