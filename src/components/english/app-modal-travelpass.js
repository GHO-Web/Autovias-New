	...
	connectedCallback() {
        ...
        <div class="modal-content">
          ...
          <div class="card-modal">
            <div class="modal-header">
              <img src="../../../src/assets/img/global/gho-img/logos/logo-travel-pass.webp" alt="TravelPass Logo" title="Travel Pass Form" width="100" height="32" class="modal-logo">
      ...
      <div id="modalTravelPassLogueado" class="ModalTravelPs">
        <div class="modal-content">
          ...
          <div class="card-modal">
            <div class="modal-header">
              <img src="../../../src/assets/img/global/gho-img/logos/logo-travel-pass.webp" alt="TravelPass Logo" title="Travel Pass Logo" width="100" height="32" class="modal-logo">
            </div>
