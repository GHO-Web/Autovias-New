...
import "../components/cards/app-cards-title-img-text.js";

class AppTicketsSalesLocations extends HTMLElement {
  async connectedCallback() {
    this.innerHTML = `
      <section class="__section-tickets-sales-locations">
        <app-section-title section-title="¿Dónde puedo comprar boletos de autobús Autovías La Línea?"></app-section-title>
        <article class="__article-tickets-sales-locations">
          <h3 class="__subtitle">Compra boletos de autobús Autovías La Línea de manera fácil y segura</h3>
