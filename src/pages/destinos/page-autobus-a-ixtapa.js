...
class AutobusAIxtapaZihuatanejo extends HTMLElement {
	async connectedCallback() {
		this.innerHTML = `
			...
			<app-banner-slider
				slides-data='[
					{"id": "slide1", "title": "Banner 1", "image": "../../src/assets/img/banner/web/banner-ixtapa.webp","mediumImage": "../../src/assets/img/banner/tablet/banner-ixtapa.webp", "smallImage": "../../src/assets/img/banner/movil/banner-ixtapa.webp", "link": "#index.html/banner1"}]'
			>
			</app-banner-slider>
