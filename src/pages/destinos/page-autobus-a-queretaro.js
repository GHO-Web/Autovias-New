...
<section class="__section __section__monterrey__destinations">
	...
	<p class="__paragraph">
		Querétaro, Patrimonio Cultural de la Humanidad, combina historia, modernidad y una ubicación estratégica que la convierte en uno de los destinos más atractivos del centro de México. Con Autovías La Línea, tu viaje a Querétaro será tan placentero como el destino mismo: disfruta de asientos reclinables, entretenimiento a bordo y un servicio de primera clase que te acompañará durante todo el trayecto.
	</p>
	<p class="__paragraph">
...
<section class="cta">
	<div class="container">
		<h2 class="cta__title">¡Viaja a Querétaro con Autovías La Línea!</h2>
