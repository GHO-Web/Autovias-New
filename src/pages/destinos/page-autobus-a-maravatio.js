...
class AppAutobusMaravatio extends HTMLElement {
	async connectedCallback() {
        ...
        <article class="container hero__content">
            ...
            <a href="../boletos-autobus/maravatio.html" class="btn btn--primary" target="_blank" aria-label="Comprar boletos" tabindex="0">
                Comprar boletos
            </a>
        </article>
			</section>
			...
			<section class="cta">
					<article class="container cta__content">
							...
							<div class="cta__action">
									<a href="../boletos-autobus/maravatio.html" class="btn btn--primary" aria-label="Comprar boletos" tabindex="0">
