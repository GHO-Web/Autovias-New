...
class AutobusAMorelia extends HTMLElement {
  async connectedCallback() {
    this.innerHTML = `
			...
			<app-banner-slider
					slides-data='[
					{"id": "slide1", "title": "Banner 1", "image": "../../src/assets/img/banner/web/banner-morelia.webp","mediumImage": "../../src/assets/img/banner/tablet/banner-morelia.webp", "smallImage": "../../src/assets/img/banner/movil/banner-morelia.webp", "link": "#index.html/banner1"}]'
			>
			</app-banner-slider>
			...
			<section class="cta">
				<div class="container">
					...
					<a href="../boletos-autobus/morelia.html" class="btn btn--primary btn--large" target="_blank" rel="noopener noreferrer" aria-label="Comprar boletos" tabindex="0">Consulta horarios y compra tu boleto</a>
				</div>
			</section>
  ...
  async loadAndRenderGridItems() {
    ...
    try {
      const response = await fetch(
        "../../src/data/destinos/morelia/lugares.json"
      );
      if (!response.ok) {
  ...
  async loadAndRenderFoodCards() {
    ...
    try {
      const response = await fetch(
        "../../src/data/destinos/morelia/platillos.json"
      );
      if (!response.ok) {
        throw new Error(
  ...
  async loadAndRenderDropdowns() {
    try {
      const response = await fetch(
        "../../src/data/destinos/morelia/dropdown-preguntas-frecuentes.json"
      );
      if (!response.ok) {
...
customElements.define("page-autobus-a-morelia", AutobusAMorelia);
