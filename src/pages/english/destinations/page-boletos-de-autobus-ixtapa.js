...
class PageBoletosAutobusIxtapaEnglish extends HTMLElement {
	async connectedCallback() {
      ...
      <div class="__first-section">
        <app-banner-image
          image-src="../../src/assets/img/english/destinations/ixtapa/banner/ixtapa.webp"
          image-alt="Promotional banner for Ixtapa"
        ></app-banner-image>
      </div>
      <section class="__section">
        <app-description-destination
          title-text="Ixtapa is waiting. Autovías La Línea will take you there."
          image-data='[
            {"id": "1", "src": "../../src/assets/img/english/destinations/ixtapa/overflow-images/balsas.webp", "alt": "Balsas River Lookout"},
            {"id": "2", "src": "../../src/assets/img/english/destinations/ixtapa/overflow-images/ixtapa.webp", "alt": "Huetamo Cultural Center"},
            {"id": "3", "src": "../../src/assets/img/english/destinations/ixtapa/overflow-images/recreational.webp", "alt": "La Cañada Recreational Zone"}
          ]'
          paragraph-text="Ixtapa is a sun-drenched town in the Tierra Caliente region of Michoacán, known for its warm climate, vibrant traditions, and deep-rooted community spirit. Nestled near the Balsas River and surrounded by rugged hills, this destination blends natural beauty with cultural pride. From scenic viewpoints and artisan spaces to lively plazas and local music, Huetamo invites travelers to experience the heart of Michoacán — with style and peace of mind."
        ></app-description-destination>
      </section>
      <section class="__section">
        <app-section-title section-title="Explore the Highlights of Ixtapa"></app-section-title>
      ...
      <section class="__section">
        ...
        <app-card-image-tag-text data-src="../../src/data/english/destinations/ixtapa/food.json"></app-card-image-tag-text>
      </section>
      ...
      <section class="__section">
        ...
        <app-destiny-slider src="../../src/data/english/destinations/ixtapa/grid-text-data.json"></app-destiny-slider>
      </section>
	...
	async _loadExploreSectionData() {
		try {
			const response = await fetch(
				"../../src/data/english/destinations/ixtapa/cards-explore-section.json"
			);
			if (!response.ok) {
...
customElements.define(
	"page-boletos-de-autobus-ixtapa-english",
	PageBoletosAutobusIxtapaEnglish
);
