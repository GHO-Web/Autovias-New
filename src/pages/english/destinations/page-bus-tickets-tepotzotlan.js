...
class PageBoletosAutobusTepotzotlanEnglish extends HTMLElement {
  async connectedCallback() {
    this.innerHTML = `
      ...
      <div class="__first-section">
        <app-banner-image
          image-src="../../src/assets/img/english/destinations/tepotzotlan/banner/Tepotzotlan.webp"
          image-alt="Promotional banner for Tepotzotlán"
        ></app-banner-image>
      </div>
      <section class="__section">
        <app-description-destination
          title-text="Tepotzotlán is waiting. Autovías La Línea will take you there."
          image-data='[
            {"id": "1", "src": "../../src/assets/img/english/destinations/tepotzotlan/overflow-images/center.webp", "alt": "Historic Aqueduct of Xalpa"},
            {"id": "2", "src": "../../src/assets/img/english/destinations/tepotzotlan/overflow-images/aqueduct.webp", "alt": "Plaza Virreinal"},
            {"id": "3", "src": "../../src/assets/img/english/destinations/tepotzotlan/overflow-images/tarascas.webp", "alt": "Crafts Market"}
          ]'
          paragraph-text="Tepotzotlán is a charming highland town just north of Mexico City, known for its colonial architecture, artisan culture, and scenic surroundings. As a designated Pueblo Mágico, it offers a blend of history, nature, and local flavor. From its iconic aqueduct and lively plazas to its traditional markets and cultural spaces, Tepotzotlán invites travelers to explore a destination full of character and tranquility — with style and peace of mind."
        ></app-description-destination>
      </section>
      <section class="__section">
      ...
      <section class="__section">
        ...
        <p class="text-description">
          ...
          Tepotzotlán’s cuisine is a fusion of pre-Hispanic ingredients and colonial techniques. From earthy stews to exotic snacks and handmade sweets, every dish reflects the town’s culinary creativity and cultural depth.
        </p>
        <app-card-image-tag-text data-src="../../src/data/english/destinations/tepotzotlan/food.json"></app-card-image-tag-text>
      </section>
      ...
      <section class="__section">
        ...
        <app-destiny-slider src="../../src/data/english/destinations/tepotzotlan/grid-text-data.json"></app-destiny-slider>
      </section>
...
customElements.define(
  "page-boletos-de-autobus-tepotzotlan-english",
  PageBoletosAutobusTepotzotlanEnglish,
);
