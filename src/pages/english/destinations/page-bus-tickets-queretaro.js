...
class PageBoletosAutobusQueretaroEnglish extends HTMLElement {
  async connectedCallback() {
    this.innerHTML = `
      ...
      <div class="__first-section">
        <app-banner-image
          image-src="../../src/assets/img/english/destinations/queretaro/banner/Queretaro.webp"
          image-alt="Promotional banner for Querétaro"
        ></app-banner-image>
      </div>
      <section class="__section">
        <app-description-destination
          title-text="Querétaro is waiting. Autovías La Línea will take you there."
          image-data='[
            {"id": "1", "src": "../../src/assets/img/english/destinations/queretaro/overflow-images/center.webp", "alt": "Historic Aqueduct"},
            {"id": "2", "src": "../../src/assets/img/english/destinations/queretaro/overflow-images/aqueduct.webp", "alt": "Teatro de la República"},
            {"id": "3", "src": "../../src/assets/img/english/destinations/queretaro/overflow-images/tarascas.webp", "alt": "Plaza de Armas"}
          ]'
          paragraph-text="Querétaro is a colonial jewel in the heart of Mexico, where history, innovation, and artistry converge. Known for its UNESCO-listed historic center, vibrant plazas, and cultural legacy, this city offers a refined yet energetic experience. From its iconic aqueduct and civic landmarks to its thriving arts scene and walkable streets, Querétaro invites travelers to explore a destination that blends elegance, heritage, and modern charm — with style and peace of mind."
        ></app-description-destination>
      </section>
      <section class="__section">
        <app-section-title section-title="Explore the Highlights of Querétaro"></app-section-title>
      ...
      <section class="__section">
        ...
        <app-card-image-tag-text data-src="../../src/data/english/destinations/queretaro/food.json"></app-card-image-tag-text>
      </section>
  ...
  async _loadExploreSectionData() {
    try {
      const response = await fetch(
        "../../src/data/english/destinations/queretaro/cards-explore-section.json",
      );
      if (!response.ok) {
...
customElements.define(
  "page-boletos-de-autobus-queretaro-english",
  PageBoletosAutobusQueretaroEnglish,
);
