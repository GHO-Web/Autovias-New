...
class AppColima extends HTMLElement {
	async connectedCallback() {
		...
		<app-modal-doters></app-modal-doters>
            <app-banner-slider
                slides-data='[
                {"id": "slide1", "title": "Banner 1", "image": "../src/assets/img/global/banner/banner-colima.webp","mediumImage": "./src/assets/img/global/banner/banner-monterrey-tablet.png", "smallImage": "./src/assets/img/global/banner/banner-colima.webp", "link": "#index.html/banner1"}]'
            >
            </app-banner-slider>
