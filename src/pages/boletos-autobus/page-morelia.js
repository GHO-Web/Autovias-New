        ...
        >
			...
			<section class="hero">
				<div class="hero__content">
					<h1 class="hero__title">Autobús a Morelia con Autovías</h1>
			...
			<section class="cta">
				<div class="container">
					...
					<a href="/destinos/autobus-a-morelia.html" class="btn btn--primary btn--large" target="_blank" rel="noopener noreferrer" aria-label="Ver todas las promociones a Atlacomulco" tabindex="0">Ver mas sobre el destino.</a>
				</div>
			</section>
