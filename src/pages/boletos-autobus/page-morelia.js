...
class AppMorelia extends HTMLElement {
	async connectedCallback() {
		...
		<app-modal-doters></app-modal-doters>
            <app-banner-slider
                slides-data='[
                {"id": "slide1", "title": "Banner 1", "image": "../src/assets/img/global/banner/Morelia_Banner_web.webp","mediumImage": "./src/assets/img/global/banner/tablet/Morelia_tablet.webp", "smallImage": "./src/assets/img/global/banner/mobile/Morelia_mobile.webp", "link": "#index.html/banner1"}]'
            >
            </app-banner-slider>
...
customElements.define("page-morelia", AppMorelia);
