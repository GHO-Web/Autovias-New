        ...
        >
			...
			<section class="hero">
				<div class="hero__content">
					<h1 class="hero__title">Autobus a Atlacomulco con Autovías</h1>
			...
			<section class="cta">
				<div class="container">
					<h2 class="cta__title">¡Viaja a Atlacomulco con Autovías!</h2>
					<p class="cta__subtitle">¡Compra tu boleto hoy mismo y disfruta un viaje seguro, económico y accesible!</p>
					<a href="/destinos/autobus-a-atlacomulco.html" class="btn btn--primary btn--large" target="_blank" rel="noopener noreferrer" aria-label="Ver todas las promociones a Atlacomulco" tabindex="0">Ver mas sobre el destino.</a>
				</div>
			</section>
