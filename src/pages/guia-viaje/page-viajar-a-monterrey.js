...
class AppViajarMonterrey extends HTMLElement {
		...
		this.innerHTML = `
			...
			<section class="hero" style='background-image: linear-gradient(rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.6) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuAwRaNTXjC4hzOr7ORLU-a3-j_UGbsvK7KtPHMWzlMIR7xRNvcNaGo5GljsW9D44Ws7OgfDXE9ZPKBCpsr_uf_g_-ztpdGzfFPThxKuqb2hzD5nT362Mv4oP93kRGTkAx9UnO_P23Y8b_Zh0Kzt0FfD8RNTp80XvDNVvgy3PM5RpC3-DSI9e35zvy0R7kCRBq5Q6i4QAZYrBVNatDorVIR8azyZFtazNR6phcIv6Whute_reg49odo8zdG3_O3E2MSzmGst9hwG-0A");'>
					<div class="hero__content">
							...
							<a href="../destinos/autobus-a-monterrey.html" class="btn btn--primary btn--large" target="_blank" aria-label="Comprar boletos" tabindex="0">Conoce más</a>
					</div>
			</section>
			...
			<section class="cta">
					<div class="container">
							...
							<a href="../destinos/autobus-a-monterrey.html" class="btn btn--primary btn--large" target="_blank" rel="noopener noreferrer" aria-label="Comprar boletos" tabindex="0">Consulta horarios y compra tu boleto</a>
					</div>
			</section>
